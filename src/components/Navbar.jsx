...
export const Navbar = () => {
  ...
  return (
    <nav
      className="flex w-full h-[10%] h-min-[60px] pt-[20px] pb-[20px] rounded-t-md items-center justify-around"
      data-testid="navbar"
    >
      <button className="p-2 rounded-md bg-[#F3F3F3] font-[600]">
        Open files
      </button>
      <div className="flex items-center space-x-2 p-2 border rounded-md shadow-sm bg-white h-full">
      ...
      <div className="flex items-center space-x-2 p-2 border-b-2 border-gray-400 focus-within:border-gray-600 bg-white h-full">
        <input
          type="text"
