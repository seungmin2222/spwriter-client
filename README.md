...
- [🧩 Challenges](#-challenges)
  ...
  - [5. 드래그로 여러 이미지 선택 및 해제를 한번에?](#5-드래그로-여러-이미지-선택-및-해제를-한번에)
    - [1) 기능의 필요성 및 목적](#1-기능의-필요성-및-목적)
    - [2) 구현 방법 및 사용된 알고리즘](#2-구현-방법-및-사용된-알고리즘)
    - [3) 드래그 영역 생성 및 시각화](#3-드래그-영역-생성-및-시각화)
    - [4) 이미지 선택 및 해제](#4-이미지-선택-및-해제)
    - [5) 사용자 경험 향상을 위한 고려사항](#5-사용자-경험-향상을-위한-고려사항)
    - [6) 기능 구현의 효과](#6-기능-구현의-효과)
    - [7) 기술적 구현의 핵심 포인트](#7-기술적-구현의-핵심-포인트)
  ...
  - [7. 스프라이트 시트를 다시 개별의 이미지로?](#7-스프라이트-시트를-다시-개별의-이미지로)
